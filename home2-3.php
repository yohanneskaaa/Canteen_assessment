...
<main>
    ...
    <?php
    /*Query searching for items in food, drinks and treats tables in database*/
    ...
    <!--specials form-->
    <form class="specialss" name='specials_form' id='specials_form' method = 'get' action ='home2-3.php'>
        <select class="specials" id = 'special' name = 'special'>

            <!--Monday-Friday drop down menu-->
            <?php
    ...
    <?php
    /*Display order of the days specials*/
